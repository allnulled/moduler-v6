module.exports = async function ({ assert: assertLoudly, utils, compilerV6, modulerV6, devBinaryV6, injection }) {
  ...
  Clear_previous_tests: {
    ...
    await devbinOne.files.makeDirectory.try("@/dist/src");
    await devbinOne.files.makeDirectory.try("@/dist/src/ejemplo");
    await devbinOne.files.makeDirectory.try("@/dist/src/ejemplo/module1");
    await devbinOne.files.makeDirectory.try("@/dist/src/ejemplo/module1/domains");
