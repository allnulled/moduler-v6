module.exports = async function ({ assert, utils, compilerV6 }) {
  ...
  Test_de_reporte_de_sintaxis_moduler_import_export: {
    ...
    compilerV6.assert("@/test/assets/unit/005/framework-1.js" in output.report.tree, "Can compile with {to:'data'} and return $moduler.imported/exported dependencies (104)");
    compilerV6.assert("@/test/assets/unit/005/framework-2.js" in output.report.tree, "Can compile with {to:'data'} and return $moduler.imported/exported dependencies (105)");
    compilerV6.assert("@/test/assets/unit/005/framework-3.js" in output.report.tree, "Can compile with {to:'data'} and return $moduler.imported/exported dependencies (106)");
    ...
    compilerV6.assert(output.report.tree["@/test/assets/unit/005/app.js"]["426-457"].dependenciesOf.length > 0, `Can compile with {to:'data'} and return dependenciesOf (7)`);
  }
