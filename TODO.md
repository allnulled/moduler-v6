1. Que el touch pase los html del src al dist (copy simple de momento, pero que el index no tenga que editarlo en el dist)
...
3. Que se pueda inyectar ToC en el markdown desde el compiler/devbin
4. Que se pueda inyectar rels.json en el markdown desde el compiler/devbin
5. Falta que se pueda inyectar @__FILENAME__ en el markdown también desde el compiler/devbin
6. Que se puedan añadir hooks en el moduler:
```js
// Para añadir un hook:
